...
void BetterIdea() {
	//Большая экономия памяти и возможность использовать строковое представление купюр,
	// переопределив функцию GetIndex();
...
int main() {
	//Хеш-функция отображает объекты любого типа в числа.
	//Когда хеш-функция отображает два различных оюъекта в одно число, возникает коллизия.
